# 👨🏻‍💻Ecommerce Behavior Data Analyst Portfolio Project
...
1. **Clone the repository**
   ```bash
   git clone https://github.com/akashcstech/Ecommerce_Data_Anlytics.git
   cd Ecommerce_Data_Anlytics
